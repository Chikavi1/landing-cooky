              ...
              <div class="grid md:grid-cols-4 gap-8">
                  ...
                  <div>
                      <div class="flex items-center space-x-2 mb-4">
                          ...
                          <span class="font-bold text-lg">mypets.id</span>
                      </div>
                  ...
                  <div>
                      ...
                      <div class="space-y-2 text-sm">
                          ...
                          <div><a href="#" class="text-gray-600 hover:text-pet-blue-600 transition-colors">About</a></div>
                      </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div class="mt-6">
                          <div class="text-sm text-gray-500 mb-2">Review by →</div>
                          <div class="text-sm text-gray-600">Get feedback on your brand.</div>
                      </div>
                  </div>
              </div>
              
              <div class="border-t mt-8 pt-8 text-center text-sm text-gray-500">
                  © 2025 MyPets.id. All rights reserved.
              </div>
          </div>
      </footer>
